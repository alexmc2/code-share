...
function ToolbarTooltip({
  ...
  const sideClass =
    side === 'top'
      ? 'bottom-[calc(100%+10px)] -translate-y-1 group-hover/toolbar-hint:translate-y-0'
      : 'top-[calc(100%+10px)] translate-y-1 group-hover/toolbar-hint:translate-y-0';
  const arrowClass =
    side === 'top'
